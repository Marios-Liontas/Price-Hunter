    ...
    return (
        <div className="container mx-auto p-4">
            <div className="search-container p-4 flex flex-col items-center justify-center">
                <form onSubmit={handleSearch} className="mb-4 w-full sm:w-3/4 md:w-1/2 lg:w-1/3 flex">
                    <input
                        type="text"
                        value={searchInput}
                    ...
                    <button
                        type="submit"
                        className="ml-2 bg-slate-700 text-white px-4 py-2 rounded-r-md hover:bg-slate-600"
                    >
                        Search
                    </button>
                </form>
